...
public class SecurityController {
    ...
    public String getUserProfile(Authentication authentication, Model model) {
        try {
            ...
            // Note: La méthode findByStudent_UserId attend un Long userId
            // Adapter selon votre implémentation de User dans le package auth
            List<com.elearning.platform.model.Enrollment> enrollments = enrollmentRepository.findByStudent_UserId(user.getUserId());
